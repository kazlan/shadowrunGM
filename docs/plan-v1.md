...
- [ ] Guardar hosts visitados por `seedId`, no por coordenadas exactas del jugador.
...
- [ ] Implementar proveedor OpenStreetMap/Overpass para MVP.
...
- [ ] Diseñar 8 arquetipos de empresa con recompensas y amenazas propias.
...
- [ ] Producir iconos finales de PWA en 192, 512 y maskable.
- [ ] Producir fondos verticales 9:16 y variantes por arquetipo.
