...
El scanner local solicita geolocalización desde la UI y redondea la posición antes de usarla. Mientras no exista proveedor real, se usa un proveedor demo desplazado cerca de la posición aproximada. Si el permiso falla, la app vuelve a objetivos demo sin bloquear la experiencia.
